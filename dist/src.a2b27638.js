...
exports.Axios = Axios;
},{"./lib/axios.js":"node_modules/axios/lib/axios.js"}],"node_modules/parcel-bundler/src/builtins/bundle-url.js":[function(require,module,exports) {
var bundleURL = null;
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return _axios.default.get("https://api.tvmaze.com/shows/82/episodes");
        case 3:
          ...
          return _context.abrupt("return", listItems);
        case 10:
          _context.prev = 10;
...
var createListElement = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 2:
          ...
          listItems.forEach(function (movie) {
            ...
            ///st 2-1
            var div_row_st2 = document.createElement("div");
            div_row_st2.classList.add("row");
            ///
            var div_st2_name = document.createElement("div");
            var div_st2_season = document.createElement("div");
            var div_st2_episode = document.createElement("div");
            div_st2_name.classList.add("name");
            div_st2_season.classList.add("season");
            div_st2_episode.classList.add("episode");
            ///////st 2-2
            var div_row_st2_2 = document.createElement("div");
            div_row_st2_2.classList.add("row");
            //
            var div_st2_2_summary = document.createElement("div");
            var div_st2_2_img = document.createElement("img");
            div_st2_2_summary.classList.add("summary");
            div_st2_2_img.classList.add("img");
            for (var key in movie) {
              if (key === "name") {
                div_st2_name.appendChild(document.createTextNode(" name: ".concat(movie[key])));
                div_row_st2.appendChild(div_st2_name);
              }
              if (key === "season") {
                div_st2_season.appendChild(document.createTextNode(" season: ".concat(movie[key])));
                div_row_st2.appendChild(div_st2_season);
              }
              if (key === "number") {
                div_st2_episode.appendChild(document.createTextNode(" episode: ".concat(movie[key])));
                div_row_st2.appendChild(div_st2_episode);
              }
              if (key === "image") {
                var image = movie[key];
                for (var key2 in image) {
              ...
              if (key === 'summary') {
                var summary = movie[key].slice(3, -4);
                div_st2_2_summary.appendChild(document.createTextNode("summary: ".concat(summary)));
  ...
  return function createListElement() {
  ...
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          _context3.t0 = createListElement;
          _context3.next = 3;
          return getTodoItems();
        case 3:
...
main();
},{"regenerator-runtime/runtime":"node_modules/regenerator-runtime/runtime.js","axios":"node_modules/axios/index.js","./style.scss":"src/style.scss"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
